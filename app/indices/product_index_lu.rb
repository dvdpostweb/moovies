ThinkingSphinx::Index.define :product, :with => :active_record, :name => 'product_lu' do
  ...
  has streaming_products_lu('DISTINCT streaming_products.`imdb_id`'), :as => :streaming_imdb_id, :type => :integer, :multi => true
  has streaming_products_lu('DISTINCT streaming_products.`language_id`'), :as => :language_ids, :type => :integer, :multi => true
  has streaming_products_lu('DISTINCT streaming_products.`subtitle_id`'), :as => :subtitle_ids, :type => :integer, :multi => true
  ...
  has vod_online_lu('DISTINCT vod_online_lus_products.`imdb_id`'), :as => :imdb_id_online, :type => :integer, :multi => true
  has vod_online_lu('DISTINCT vod_online_lus_products.`language_id`'), :as => :online_language_ids, :type => :integer, :multi => true
  has vod_online_lu('DISTINCT vod_online_lus_products.`subtitle_id`'), :as => :online_subtitle_ids, :type => :integer, :multi => true
