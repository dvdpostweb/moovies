module ApplicationHelper
  ...
  def streaming_access?
    session[:country_id] == 22 || session[:country_id] == 131 || session[:country_id] == 0 || session[:country_id] == 161 || session[:country_id] == 161 || (current_customer && current_customer.super_user?)
  end
