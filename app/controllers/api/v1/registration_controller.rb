      ...
      if params[:moovie_id].present?
        ...
        if product
          ...
          if customer.save(validate: false)
            ...
            redirect_to_product_path = edit_customer_payment_methods_path(:customer_id => customer.to_param, :type => :tvod, :product_id => product.to_param) #product_path(:id => product.to_param)
