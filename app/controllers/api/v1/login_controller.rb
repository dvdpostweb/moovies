    ...
    if resource.valid_password?(password)
      if moovie_id.present?
        ...
        if customer.save(validate: false)
          ...
          if ((current_customer.customers_abo_payment_method == 0 && current_customer.customers_abo_type != 6) || (current_customer.customers_abo_payment_method == 0 && current_customer.unlimited_subscriber?))
