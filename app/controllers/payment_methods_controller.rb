class PaymentMethodsController < ApplicationController
  ...
  def update
    ...
    if current_customer.have_freetrial_codes?
      list = { "Account.PSPID" => ENV["OGONE_PSPID"], "Alias.AliasId" => @alias, "Alias.OrderId" => @order_id, "Alias.StorePermanently" => "Y", "Parameters.AcceptUrl" => @url_ok, "Parameters.ExceptionUrl" => @url_back, "Card.Brand" => @brand.upcase, "Card.PaymentMethod" => "" } 
